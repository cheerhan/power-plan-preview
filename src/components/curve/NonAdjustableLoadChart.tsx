...
import { generateMockNonAdjustableLoadData } from '@/lib/curve-utils';
...
const NonAdjustableLoadChart = ({ chartHeight = 400 }: Props) => {
  const data = useMemo(() => generateMockNonAdjustableLoadData(), []);
...
export default NonAdjustableLoadChart;
